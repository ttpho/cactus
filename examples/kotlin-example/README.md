# Cactus Kotlin Example App

This is a simple Android application that demonstrates how to use the Cactus library to run LLMs on Android.
...
Refer to the `MainActivity.kt` file for the implementation details.
